...
def level_1(level):
    ...
    while True:
        ...
        if option == '1':
            ...
            print_pause("and fall into the abyss.\n")
            game_over(level)
        else:
            print_pause("Please make a valid selection")
    return option
    ...
    while True:
        if deep_pit == "1":
            ...
            if chance == 1:
                ...
                print_pause("across the deep dark pit...\n")
                print_pause("and landed safely on the other side!\n")
                level_4(level)
            if chance == 2:
                print_pause("\nYou back up a few good feet...\n")
                print_pause("to get a running start...\n")
                ...
                print_pause("before exhaling...\n")
                print_pause("This is it! You dash down the dirt pathway...\n")
                print_pause("mis-calculat your footing...\n")
                print_pause("trip and fall head first...\n")
                print_pause("into the deep dark pit...\n")
                game_over(level)
        elif deep_pit == '2':
            print_pause("\nYou take a second to think things through.\n")
            print_pause("You noticed...\n")
            print_pause("that right above in the middle of the pit\n")
            ...
            print_pause("you toss one end onto the branch!\n")
    ...
    while True:
        if golden_monkey == '1':
            ...
            if chance == 1:
                ...
                print_pause("and realized you have made a grave mistake...\n")
            ...
            print_pause("and immediately replace it with the sand bag.\n")
...
def level_5(level):
    ...
    print_pause("and you are right in it's path...\n")
    print_pause("You make a run for it,\n")
    print_pause("towards an opening,\n")
    print_pause("through to the end of a tunnel.\n")
    print_pause("The boulder chases you...\n")
    print_pause("You come out of the tunnel,\n")
    ...
    while True:
        if jump == '1':
            ...
            print_pause("...\n")
            print_pause("...\n")
            print_pause("You crash in to the river...\n")
            print_pause("just barely holding onto the golden monkey...\n")
            print_pause("The boulder flys out of the tunnel above \n")
            print_pause("and you hear it crash\n")
            print_pause("into the river right beind you...\n")
            print_pause("and the waves are felt across your body.\n")
            print_pause("You have survived the jump!\n")
            print_pause("You swim to shore \n")
            print_pause("and radio in your plane to take you home...\n")
            print_pause("The plane arrives and you get in.\n")
            print_pause("Before you take off, you hear an alarm go off...\n")
            print_pause("Ring!\n")
            print_pause("Ring!!\n")
            print_pause("Ring!!!\n")
            print_pause("You find yourself, laying in your bed.\n")
            print_pause("You reach over to shut off the alarm.\n")
            print_pause("This magical adventure...\n")
            print_pause("was all a dream.\n")
            print_pause("At least this isn't Game Over.\n")
            ...
            print_pause("The huge boulder crashes ontop of you,\n")
